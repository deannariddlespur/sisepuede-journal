...
urlpatterns = [
    ...
    path('define-your-path/event/<int:pk>/join/', views.path_event_join, name='path_event_join'),
    path('define-your-path/event/<int:pk>/leave/', views.path_event_leave, name='path_event_leave'),
